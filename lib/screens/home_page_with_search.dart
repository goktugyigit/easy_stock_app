...
class _HomePageWithSearchState extends State<HomePageWithSearch> {
  ...
  static const double bottomNavBarTotalHeightEstimate = 58.0 + 22.0 + 8.0;
                  ...
                  child: itemsToDisplay.isEmpty
                      ...
                      : ListView.builder(
                          padding: EdgeInsets.only(
                            ...
                            bottom: bottomNavBarTotalHeightEstimate + listItemVerticalPadding,
                          ),
                                      ...
                                      children: [
                                        if (currentDirection != null)
                                          Positioned(
                                            ...
                                            child: _buildActionBackgroundLayer( // _buildActionBackgroundLayer kullanılıyor
                                              currentDirection == DismissDirection.startToEnd ? Colors.red.shade700 : AppTheme.accentColor, // AppTheme importu gerekli
                                        ...
                                        Dismissible(
                                          ...
                                          confirmDismiss: (direction) async {
                                            ...
                                            if (direction == DismissDirection.endToStart) {
                                              ...
                                              confirmed = await _showDeleteConfirmationDialog(currentItemContext, item); // _showDeleteConfirmationDialog kullanılıyor
                                              confirmed ??= false;
                                            }
                                            if (confirmed == false) {
                                              setState(() {
                                          ...
                                          // DÜZELTME: StockItemCard'a eksik parametreler eklendi
                                          child: StockItemCard(
                                            key: ValueKey('stock_card_fg_${item.id}'),
                                            stockItem: item, // Zorunlu parametre
                                            globalMaxStockThreshold: _globalMaxStockThreshold, // Zorunlu parametre
                                            onTap: () {
